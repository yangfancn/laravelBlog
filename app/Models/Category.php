 ...
 * @property int $status
 * @property int $show
 * @property int $type 0:单页面，1:文章栏目
 * @property int $pid
 * @property int $rank
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Category whereDirect($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Category whereDirectory($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Category whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Category whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Category wherePid($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Category whereRank($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Category whereRoute($value)
