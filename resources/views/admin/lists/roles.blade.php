          ...
          <div class="card card-info">
            <div class="card-header">
              ...
              <div class="card-tools">
                <a type="button"
                   class="btn btn-tool open-iframe-modal"
                    ...
                    <form action="{{ route('admin.roles.index') }}" method="GET">
                      <div class="input-group input-group-sm">
                        ...
                        <span class="input-group-append">
                                                <button type="submit"
                                                        class="btn btn-info btn-flat">查找</button>
                                            </span>
                      </div>
                    </form>
                  </div>
                ...
                @foreach($data as $key => $item)
                  <tr data-id="{$item.id}">
                    ...
                    <td>
                      ...
                      <a href="javascript:;"
                         data-href="{{ route('admin.roles.status', $item['id']) }}"
                      ...
                      <a href="javascript:;" class="btn btn-sm delete"
                         data-href=" {{ route('admin.roles.destroy', $item['id']) }}" title="删除"><i
