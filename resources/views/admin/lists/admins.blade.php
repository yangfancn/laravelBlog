          ...
          <div class="card card-info">
            <div class="card-header">
              ...
              <div class="card-tools">
                <a type="button" class="btn btn-tool open-iframe-modal" href="{{ route('admin.admins.create') }}">
              ...
              <table class="table table-hover">
                ...
                @foreach($data as $key => $item)
                  <tr data-id="{$item.id}">
                    ...
                    <td>
                      <a href="{{ route('admin.admins.edit', $item['id']) }}" class="btn btn-sm" title="编辑"><i
                          class="fa fa-pencil"></i></a>
                      <a href="javascript:;"
                         data-href="{{ route('admin.admins.status', $item['id']) }}"
                      ...
                      <a href="javascript:;" class="btn btn-sm delete"
                         data-href=" {{ route('admin.admins.destroy', $item['id']) }}" title="删除"><i
